...
exports.saveLog = exports.helloWorld = void 0;
...
function helloWorld(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var query, tasks, _i, tasks_1, task, taskKey;
...
function saveLog(req, res) {
    ...
    res.status(200).send({ uid: uid, title: title, description: description });
}
